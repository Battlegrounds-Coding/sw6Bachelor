...
class SerialCom:
    ...
    def write(self, x: str) -> None:
        """Write a bytes package to the connected device, every command is ends on a cardinal return"""
    ...
    def set_pump(self, value: int) -> None:
        ...
        if rtn.pop(-1) == "Please apply a new value:":
            ...
            raise Exception("Invalid pump value, Out of bounds [0..255] given value: " + str(value))
