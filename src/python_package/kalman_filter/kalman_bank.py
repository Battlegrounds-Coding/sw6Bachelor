...
class KalmanBank:
    ...
    def __init__(self, faults : List[Callable[[MeasurementData], MeasurementData]], initial_state: np.float64, initial_variance: np.float64, delta: timedelta, noice: np.float64 = np.float64(0.0)):
        self.faults = faults
    ...
    def add_faults(self, new_faults: List[Callable[[MeasurementData], MeasurementData]], initial_state: np.float64, initial_variance: np.float64, delta: timedelta, noice: np.float64 = np.float64(0.0)):
